...
class TrainModels:
    def __init__(self, config,base_path=''):
        ...
        self.cumulative_importance_threshold = config.get("build",{}).get("cumulative_importance_threshold", 0.95)
    ...
    def load_data(self):
        ...
        try:
            ...
            prepared_data_file = os.path.join(self.output_folder,"Prep", "prepared_data.csv")
