...
class DataPreparation:
    ...
    def standardize_or_normalize(self):
        ...
        print(self.index_col+" "+self.target)
        numeric_cols = [col for col in numeric_cols if col not in [self.index_col, self.target]]
        print("columns for standarization: ",numeric_cols)
